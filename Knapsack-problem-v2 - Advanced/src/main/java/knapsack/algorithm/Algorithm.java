...
import knapsack.handlers.threadmanager.ThreadAlgorithm;
...
public class Algorithm {
    ...
    public int[] getBeamSearch(ThreadAlgorithm threadAlgorithm){
    ...
    public void setSolutionOfLowerBound(int[] solutionOfLowerBound) {
        this.solutionOfLowerBound = solutionOfLowerBound;
    }

    public void setValueOfLowerBound(int valueOfLowerBound) {
        this.valueOfLowerBound = valueOfLowerBound;
    }
}
